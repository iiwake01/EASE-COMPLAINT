...
class FirestoreService extends GetxService {
  ...
  Future<ComplaintModel?> getComplaint(String? id) async {
    final response = await dbFirestore.collection("complaints").where(Constants.ID, isEqualTo: id).get();
    return response.docs.map((doc) => ComplaintModel.fromSnapshot(doc)).firstOrNull;
  }
