    ...
    return Scaffold(
      appBar: BackAppBar(
        ...
        title: AppLocalizations.of(context)
            .translate('what_type_of_complaint_are_you_going_to_file_'),
      ),
                ...
                children: <Widget>[
                  FileComplaintButton(
                    ...
                    text: AppLocalizations.of(context)
                        .translate('environmental_problems'),
                  ),
                  FileComplaintButton(
                    onPressed: () => controller.launchCommunityConflicts(),
                    text: AppLocalizations.of(context)
                        .translate('community_conflicts'),
                  ),
                ],
              ),
              SizedBox(
              ...
              Row(
                ...
                children: <Widget>[
                  FileComplaintButton(
                    ...
                    text: AppLocalizations.of(context)
                        .translate('public_disturbances'),
                  ),
                  FileComplaintButton(
                    onPressed: () => controller.launchCrimeRelated(),
                    text:
                        AppLocalizations.of(context).translate('crime_related'),
                  ),
                ],
              ),
              SizedBox(
