...
class ComplaintFormController extends BaseController {
  ...
  TextEditingController? urgencyController,
      locationController,
      narrativeController,
      previousActionConroller,
      nameController,
      contactController,
      resolutionController;
  final Rx<TextEditingController?> typeController = TextEditingController().obs,
      incidentDateController = TextEditingController().obs;
  ...
  Future<void> validate() async {
    ...
    final isPreviousActionValid =
        previousActionConroller?.text.isBlank == false;
  ...
  Future<void> _createComplaint() async {
    ...
    try {
      TaskSnapshot? taskSnapshot =
          await _storage.uploadPlatformFiles(attatchmentFile);
