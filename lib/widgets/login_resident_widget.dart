          ...
          children: <Widget> [
            ...
            Row (
              ...
              children: [
                ...
                TextButton ( onPressed: () { controller.launchSignUp(); }, child: Text(AppLocalizations.of(context).translate('sign_up_here'), style: const TextStyle(color: Colors.green, fontSize: 20),) ),
              ],
            ), 
            ElevatedButton (
